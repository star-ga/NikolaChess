...
|------------|-------------|---------------------|
| GPU NNUE Evaluation | 50M+ positions/sec | 500K positions/sec (CPU) |
...
- **GPU-Batched NNUE**: Lazy SMP threads batch positions for GPU inference (50M+ pos/sec)
...
│   │
│   ├── GPU Acceleration
│   │   └── gpu/batched_nnue.mind - GPU-batched NNUE for Lazy SMP (50M+ pos/sec)
│   │
│   ├── Deep Evaluation
...
- GPU-batched NNUE for Lazy SMP threads (50M+ positions/sec)
